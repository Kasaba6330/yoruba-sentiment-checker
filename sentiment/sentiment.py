...
# Load Yoruba-specific resources
...
sentiment_model = LogisticRegression(max_iter=2000, solver='saga', multi_class='multinomial', verbose =1, class_weight='balanced')
